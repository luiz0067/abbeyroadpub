...
<div id="tudo4">
  <div id="content">
    ...
    <div id="content_right">
      <div class="titulo_pagina">Photos</div>
      <div id="galeria-fotos">
      <div id="tenso">Galeria de Fotos</div>
      <!-- inicio dos itens da pagina de fotos -->
		<?php
			...
			$sql = "SELECT id,data_evento,titulo,conteudo FROM categoria_fotos"; //altere (designgrafico) para o nome de sua tabela.
			...
			$total="1";
			$sql    = "SELECT id,data_evento,titulo,conteudo FROM categoria_fotos LIMIT $inicio, $lpp;";
		...
		?>
      	...
      	<div class="linhas-galeria-fotos">
            ...
            <div class="descricao-evento-foto"><a href="photosfinal.php?id_categoria_fotos=<?php echo $row['id'];?>"><h3 class="linkcomum"><?php echo $row['titulo'];?></h3></a></div>
        </div>
	...
	<div id="pagination-fotos">
			<?php
				if(!$total==$colunas){
					...
					{    
					echo "<a class='seletores-pagina'>";    
					echo "<a class='seletores-pagina' href=\"photos.php?pg=".($pg - 1)."\" targe=\"_self\">Anterior</a> |"; // troque (pagina) pela link de sua página.    
					echo "</a>";
					}
					$i = 1;
					...
					{
					echo "<strong class='seletores-pagina'><a class='seletores-pagina'>";        
					echo " <a class='seletores-pagina' href=\"photos.php?pg=".$i."\" target=\"_self\">".$i."</a> "; // troque (pagina) pela link de sua página.        
					echo "</a></strong>";    
					}
					$i = $i + 1;
					}
					...
					{    
					echo "<a class='seletores-pagina'>";    
					echo "| <a class='seletores-pagina' href=\"photos.php?pg=".($pg + 1)."\" targe=\"_self\">Próxima</a>\n"; // troque (pagina) pela link de sua página.    
					echo "</a>"; }   
			?>
		  </div>
