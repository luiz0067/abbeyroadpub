			...
			)
			{
				if (($_FILES["imagem"]["size"] < 5*1024*1024)){
					...
					else
					{
						...
						echo "<a href=\"../uploads/agenda/g_".$imagem."\" target=\"blank\">".$imagem."</a><br>";
					}
				}
				else
				{
		...
		<table cellpadding= "7" cellspacing = "0" border= "1" width="1004">
			...
			?>
				<tr>
					...
					<td>
						<img width="60px" height="60px" src="../uploads/agenda/g_<?php echo $row['imagem'];?>">
					</td>
					<td>
						<a href="<?php echo $row['facebook'];?>" target="_blank">
							<img width="60px" height="60px" src="./imagenscrm/facebook.png">
						</a>
					</td>
					<td>
